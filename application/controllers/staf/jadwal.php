...
class jadwal extends CI_Controller{
	...
	function data_group (){
	    ...
	    $this->load->view('staf/jadwal/data_group',$data); //load tampilan content + mengirimkan $data
	}	
	...
	function kelola_group($id_kelas){
		...
		$this->load->view('staf/jadwal/data_jadwal_group',$data);
	}
	...
	function data_jadwal_group (){
	    ...
	    $this->load->view('staf/jadwal/data_jadwal_group',$data); //load tampilan content + mengirimkan $data
	}

	function data_jadwal_private (){
	    $this->load->model('m_siswa'); //load model
	    $data['data_jadwal'] = $this->m_siswa->get_data_private(); 
	    $this->load->view('staf/jadwal/data_jadwal_private',$data); //load tampilan content + mengirimkan $data
	}
	...
	function detail_jadwal_private($id_pendaftaran){
	    ...
	    $this->load->view('staf/jadwal/detail_jadwal_private',$data); //load tampilan content + mengirimkan $data
	}
