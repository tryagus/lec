            ...
            <div class="container-fluid">
                ...
                <!-- table -->                 
                  ...
                  <ul class="nav nav-tabs">
                    <li><a href="<?php echo base_url() ?>jadwal/data_group">Group</a></li>
                    <li class="active"><a href="<?php echo base_url() ?>jadwal/data_jadwal_private">Private</a></li>
                  </ul>
                  <br>                  
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        ?>    
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url();?>jadwal/detail_jadwal_private/<?php echo $data->id_pendaftaran; ?>" class="btn btn-sm btn-primary">Detail</a>
                                </td>
                            </tr>                                                                  
