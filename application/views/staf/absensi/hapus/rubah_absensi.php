        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- table -->   
                <!-- form pendaftaran -->
                <form action="<?php echo base_url(). 'absensi/update_absensi'; ?>" method="post">
                <div class="clearfix"></div> 
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 panel panel-primary form-daftar-offline">
                    <div class="panel-body daftar">
                      ...
                      <input type="hidden" class="form-control" name="id_absensi" value="<?php echo $absensi['id_absensi'] ?>">

                      <div class="col-md-12">
                        <div class="form-group margin">        
                          <input class="form-control input" placeholder="Nim" name="nim" value="<?php echo $absensi['nim'] ?>">     
                        </div>                        
                      </div>
                      <div class="col-md-12">
                        <div class="form-group margin">        
                          <input class="form-control input" placeholder="Nama" name="nama" value="<?php echo $absensi['nama'] ?>">     
                        </div>                        
                      </div>
                      <div class="col-md-4">               
