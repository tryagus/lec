                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 panel panel-primary form-daftar-offline">                    
                    <div class="panel-body daftar">
                      ...
                      <form action="<?php print site_url();?>staf/sertifikat/cari" method=POST>
                        ...
                        <input type=submit placeholder ="Masukan Nama Siswa">
                      </form> 

                      <div class="form-group margin">        
                        <input type="hidden" class="form-control input" placeholder="Id Pendaftaran" name="nama_siswa" value="<?php print $row->nama_siswa; ?>">
                      </div>    
