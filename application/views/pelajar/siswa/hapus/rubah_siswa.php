                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 panel panel-primary form-daftar-offline">
                    ...
                    <input type="hidden" class="form-control" name="id_pendaftaran" value="<?php echo $siswa['id_pendaftaran'] ?>">
                      ...
                      <div class="form-group margin">        
                        <input class="form-control input" placeholder="Nama" name="nama" value="<?php echo $siswa['nama'] ?>">          
                      </div>
                      <div class="form-group margin">        
                      ...
                      <div class="form-group margin">        
                        <input class="form-control input" placeholder="Usia" name="usia" value="<?php echo $siswa['usia'] ?>">          
                      </div>      
                      <div class="form-group">       
                        <select class="form-control" name="pendidikan_akhir" name="<?php echo $siswa['pendidikan_akhir'] ?>">
                      ...
                      <div class="form-group margin">        
                        <input class="form-control input" placeholder="Domisili" name="domisili" value="<?php echo $siswa['domisili'] ?>">          
                      </div>      
                      <div class="form-group">
                        <label>Programs</label>
                        <select class="form-control" name="program" value="<?php echo $siswa['program'] ?>">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="program" value="<?php echo $siswa['program'] ?>">
                          <option value="General English">Lunas</option>
                          <option value="Conversation Class">Belum Lunas</option>
                          <option value="Conversation Class">DP 50 %</option>
                        </select>
                      </div>
                      <div class="form-group margin">        
